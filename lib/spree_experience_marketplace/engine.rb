module SpreeExperienceMarketplace
  class Engine < Rails::Engine
    ...
    initializer "spree_experience_marketplace.preferences", before: :load_config_initializers  do |app|
      SpreeExperienceMarketplace::Config = Spree::ExperienceMarketplaceConfiguration.new
    end

    config.after_initialize do
      Stripe.api_key = SpreeExperienceMarketplace::Config[:stripe_secret_key]
    end
    ...
    def self.activate
      ...
      Spree::Ability.register_ability(Spree::ExperienceMarketplaceAbility)
    end
